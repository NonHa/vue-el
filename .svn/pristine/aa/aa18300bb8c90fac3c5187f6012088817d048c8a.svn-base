layui.define(['layer', 'form', 'laytpl'], function(exports) {
	...
	Class.prototype.events = function() {
		...
		form.on('select(' + provinceFilter + ')', function(data) {
			...
			options.change(options.data); //这里实际上是打印方法
		});
		...
		function renderProvince() {
			let tpl = '';
			let provinceList = getList("province"); //code，name
			let currentCode = '';
			let currentName = '';
			if(flag){
				tpl += '<option value="-1">不限</option>';
				options.data.province=-1;
			}
